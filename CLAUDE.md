...
| `docs/watch-imu.md` | the watch-IMU modality end-to-end: the ONE-config wave segmenter, counts (16/18 blind), the velocity ceiling + honest misses |
| `docs/capture-app.md` | **design** — the phone-as-hub capture rig: one BT clicker driving HD60 video + watch + AirPods Pro 3 (motion+HR), the watchOS arm-once constraint, build phases |
