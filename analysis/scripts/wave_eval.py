...
SESSIONS = {
    ...
    # --- 2026-07-01 SHARED squat (owner JM + wife MM), split from one mixed Vitruve export.
    # Only JM sets 2 & 5 have a WRIST recording (watch forgot for JM 1/3/4); both MM sets were
    # BAR-sleeve mounts (SQ-MM-*_watch_bar.csv, watch_bar) -> not on this wrist board.
